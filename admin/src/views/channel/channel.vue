	...
	<div>
        <Card>
            ...
            <Row class="margin-top-10 searchable-table-con1">
                <Table  :columns="columns_first" :data="userpage"  border :loading="ifLoading" ref="tabel" class='user_center'>
                </Table>
            </Row>
        ...
        <Modal  title="设置渠道" v-model="channelModal" :closable="false" @on-ok='addChannel' :mask-closable='false'>
           <div>
               <span>手机号</span>
               <!-- <input type="number" v-model='phone'> -->
               <Input v-model="phone" type="text" :autosize="true" placeholder="请输入手机号"  class='channelInput'></Input>
           </div>
        </Modal>
...
<script>
        ...
        return {
            ...
            columns_first: [
                ...
                },
                {
                    ...
                    render: (h, obj) => {
                        return h('span',{
                        }, obj.row.channelVO.channelCount)
                ...
                },
                {
                    ...
                    render: (h, obj) => {
                        return h('span',{
                        }, obj.row.channelVO.channelReward)
                    ...
                    render: (h, obj) => {
                        ...
                        return h("div", [
                            ...
                            h(
                                ...
                                on: {
                                    click: () => {
                                         this.$router.push({path:"/channel/channelDetail",query:{id:obj.row.id}})
                                    }
                                }
                                },
                                "查看详情"
    ...
    methods: {
        ...
        refreshPage(index) {
            ...
            channelList({pageNo:index,pageSize:this.pageSize})
            .then(
                res=>{
        ...
        addChannel(){
            let self=this;
            channelSetUp({mobilePhone:this.phone})
                .then(
                    res=>{
